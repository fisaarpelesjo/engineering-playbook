...
| Mecanismo removido sem que nenhum teste o note | parcial, alcance declarado | T215/T216: `src/engineering_playbook/mutation.py` remove cada mecanismo do inventario numa copia, exige que os alvos estivessem verdes antes, e so conta como apanhado um node id que passou a falhar. Medido em 2026-09-22, apos #65: 30 de 30 apanhados, e o inventario alcanca 9 das 20 etapas desta matriz -- 4, 6, 9, 11, 15, 16, 17, 18, 20. As restantes nao tem entrada, portanto o vector permanece aberto para elas. Corre como job proprio em integracao continua (AC-013), e o job de assinatura depende dele |
